...
# Кастомный CSS для крутого тёмного интерфейса
st.markdown("""
    <style>
    .stApp {
...
# 2. Подключение ИИ напрямую из Secrets (без ввода на экране)
try:
    genai.configure(api_key=st.secrets["GEMINI_API_KEY"])
    
    # Системная инструкция: робот знает, что его создал ты!
    system_instruction = "Ты — продвинутый ИИ-помощник, созданный разработчиком. Твоя задача — помогать пользователям решать любые задачи и отвечать на вопросы."
...
user_text = st.text_input("✍ *Твой вопрос или задание:*", placeholder="Напиши сюда то, что нужно решить...")
